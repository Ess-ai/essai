        ...
        <div className="relative py-16">
            ...
            <div>
                ...
                <div className="mt-6 m-auto space-y-6 md:w-8/12 lg:w-7/12">
                    <h1 className="text-center text-4xl font-bold text-gray-800 dark:text-white md:text-5xl">Call to Action</h1>
                    <p className="text-center text-xl text-gray-600 dark:text-gray-300">
                        We believe that every student deserves access to high-quality education and academic resources, regardless of their background or circumstances. Unfortunately, many refugee students and students facing barriers to education are currently struggling to access the tools and support they need to succeed academically.
                    </p>
